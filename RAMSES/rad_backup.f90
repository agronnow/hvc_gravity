...
subroutine restore_radiation
  ...
  if(IOGROUPSIZEREP>0)then
     ...
     fileloc=trim(output_dir)//'output_'//TRIM(nchar)//'/group_'//TRIM(ncharcpu)//'/radgpu_'//TRIM(nchar)//'.out'
  else
     fileloc=trim(output_dir)//'output_'//TRIM(nchar)//'/radgpu_'//TRIM(nchar)//'.out'
  endif
 call title(myid,nchar)
